...
import 'package:input_actions_editor/ui/features/gestures/editor/actions/action_summary.dart';
...
class ActionsEditorAlt extends StatefulWidget {
  const ActionsEditorAlt({
  ...
  @override
  State<ActionsEditorAlt> createState() => _ActionsEditorAltState();
}

class _ActionsEditorAltState extends State<ActionsEditorAlt> {
