...
class _SeededConfig extends ConfigController {
  _SeededConfig(this.gestures);

  final List<GestureNode> gestures;

  @override
  Future<EditSession> build() {
    final draft = assignEditIds(Config(mouseNodes: gestures));
...
Future<(ProviderContainer, GestureLocation)> _mount(
  ...
  final container = ProviderContainer(
    overrides: [
      ...
      configControllerProvider.overrideWith(() => _SeededConfig(gestures)),
    ],
  );
